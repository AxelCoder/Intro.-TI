						...
						<tbody>
							<td>
								<div class="form-group">
										...
										<select name="combo">
											<optgroup label="Empleados">
												<option value="AZ">Ana Sofia</option>
												<option value="CO">Axel Arath</option>
												<option value="ID">Beatriz Adriana</option>
												<option value="WY">Brayan Emmanuel</option>
												<option value="AL">Eduardo</option>
												<option value="IA">Jaqueline</option>
												<option value="KS">Jesus</option>
												<option value="KY">José</option>
												<option value="KS">José Manuel</option>
												<option value="KY">Pedro</option>
											</optgroup>
										</select>
									</div>
								</td>
								...
								<div class="form-group form-group-float">
										<label class="form-group-float-label">Dia de inicio</label>
										<input type="text" class="form-control" name="format-date" placeholder="Ingresa fecha de inicio">
										<span class="form-text text-muted">DD/MM/AAAA</span>
									</div>
								</td>
								<td>
										<div class="form-group form-group-float">
										<label class="form-group-float-label">Dia de finalzación</label>
										<input type="text" class="form-control" name="format-date" placeholder="Ingresa fecha de finalización">
										<span class="form-text text-muted">DD/MM/AAAA</span>
									</div>
								</td>
						</tbody>
