			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Lista de vacaciones</h5>
					...
					<table class="table datatable-basic">
						...
						<tbody>
							<tr>
                                ...
                                <td>10/10/2019</td>
                                <td>15/10/2019</td>
								<td><span class="badge badge-success">En vacaciones</span></td>
										</div>
									</div>
								</td>
							</tr>
							<tr>
                                ...
                                <td>--/--/----</td>
                                <td>--/--/----</td>
								<td><span class="badge badge-secondary">No a registrado vacaciones</span></td>
										</div>
									</div>
								</td>
							</tr>
							...
							<tr>
                                    ...
                                    <td>15/10/2019</td>
                                    <td>21/10/2019</td>
								<td><span class="badge badge-info">Vacaciones pendientes</span></td>
										</div>
									</div>
								</td>
							</tr>
				...
				<div class="modal-dialog modal-full">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title">Editar vacaciones</h5>
							<button type="button" class="close" data-dismiss="modal">&times;</button>
						</div>
                        <div class="card">
                                <div class="card-body">
                                    <form action="#">
                                        <fieldset class="mb-3">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-10">
                                                    <input type="text" class="form-control"  value="José Manuel Martinez Tirado">
                                                </div>
                                            </div>
            
                                            <div class="form-group row">
                                                <label class="col-form-label col-lg-2">Dia inicio</label>
                                                <div class="col-lg-10">
                                                    <input type="text" class="form-control"  value="18/10/2019">
                                                </div>
                                            </div>
            
                                            <div class="form-group row">
                                                <label class="col-form-label col-lg-2">Dia fin</label>
                                                <div class="col-lg-10">
                                                    <input type="text" class="form-control"  value="18/10/2019">
                                                </div>
